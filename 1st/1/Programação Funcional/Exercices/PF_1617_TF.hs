...
modaAux _ [] = []
modaAux n (x:xs) | n > snd x = modaAux n xs
...
tira x (FF y z) | x == y = AF y z
                | x == z = FA y z
                | x <  y || x >  z = FF y z
                | otherwise = Uniao (FA y x) (AF x z)
tira x (FA y z) | x == y = AA y z
                | x <  y || x >= z = FA y z
                |  otherwise = Uniao (FA y x) (AA x z)
tira x (AF y z) | x == z = AA y z
                | x <= y || x >  z = AF y z
                | otherwise = Uniao (AA y x) (AF x z)
tira x (AA y z) | x <= y || x >= z = AA y z
