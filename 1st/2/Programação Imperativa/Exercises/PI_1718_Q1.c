...
void le2Maior() {
  ...
  do {
    scanf("%d", &leitura);
    if (leitura > maior2 && leitura < maior)
      maior2 = leitura;
...
void strnoV(char t[]) {
  ...
  while (t[l] != '\0') {
    if (t[l] == 'a' || t[l] == 'e' || t[l] == 'i' || t[l] == 'o' ||
        t[l] == 'u' || t[l] == 'A' || t[l] == 'E' || t[l] == 'I' ||
        t[l] == 'O' || t[l] == 'U')
      l++;
    else
      t[e++] = t[l++];
...
int intersectMSet(int N, int v1[N], int v2[N], int r[N]) {
  ...
  for (i = 0; i < N; i++) r[i] = menor(v1[i], v2[i]);
...
int unionMSet(int N, int v1[N], int v2[N], int r[N]) {
  ...
  for (i = 0; i < N; i++) r[i] = maior(v1[i], v2[i]);
...
int iguais(Posicao p1, Posicao p2) { return (p1.x == p2.x) && (p1.y == p2.y); }
...
int distC(Posicao p) { return p.x * p.x + p.y * p.y; }
